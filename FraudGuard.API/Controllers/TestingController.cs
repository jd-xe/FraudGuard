...
public class TestingController : ControllerBase
{
    ...
    public async Task<IActionResult> SeedDatabase()
    {
        ...
        // 4. Guardamos en SQL Server
        await _context.Users.AddRangeAsync(fakeUsers);
        await _context.Merchants.AddRangeAsync(fakeMerchants);
        await _context.SaveChangesAsync();

        return Ok(new { Message = "Base de datos reseteada y sembrada con éxito", Users = 50, Merchants = 10 });
    }
}